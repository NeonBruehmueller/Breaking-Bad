...
class Block(pygame.sprite.Sprite):
    ...
    def __init__(self, color = GREEN, size = 10):
        """
...
class Ship(pygame.sprite.Sprite):
    ...
    def __init__(self, path, pos_x, pos_y, speed = 15):
        """
        Cria uma nave.
...
class Invader(pygame.sprite.Sprite):
    ...
    def shoot(self):
        ...
        """
        bullet = Bullet(self.rect.midtop, -1, speed = 15, color = RED)
        return bullet
...
class SpaceInvaders():
    ...
    def __init__(self):
        ...
        self.path_image_ship = DIRECTORY + "/images/Hank.png"
        background_image = pygame.image.load(DIRECTORY + "/images/Gangue.png")
        explosion_image = pygame.image.load(DIRECTORY + "/images/explosion.png")
        lifes_image = pygame.image.load(DIRECTORY + "/images/Drink.png")

        self.ship = pygame.sprite.GroupSingle(
                                Ship(self.path_image_ship, (SCREEN_WIDTH - 50) // 2, 
                                        (SCREEN_HEIGHT - 110)))
        self.ship_sprite = self.ship.sprites()[0]
        mystery_image = pygame.image.load(DIRECTORY + "/images/Gus.png")
    ...
    def final_screen(self):
        ...
        text2 = self.font20.render("Aperte ENTER para entrar no jogo", True, WHITE)
